...
print(f'\n{"=" * 90}')
print(f'COMBINED PERFORMANCE SUMMARY  |  Benchmark CAGR: '
      f'{all_metrics[0]["BM CAGR"]:.2%}  |  {all_metrics[0]["Weeks"]} weeks')
print(f'{"=" * 90}')
print(f'{"Variant":<10} {"Description":<34} {"CAGR":>7} {"Alpha":>7} '
      f'{"Sharpe":>7} {"Calmar":>7} {"MaxDD":>7} '
      f'{"Hit%":>6} {"Turn%":>6} {"AvgN":>5} {"NAV(M)":>8}')
print('-' * 90)
for r in all_metrics:
    print(f'{r["Variant"]:<10} {r["Description"]:<34} '
